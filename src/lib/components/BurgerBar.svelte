<script lang="ts">
	...
	import { Avatar, ProgressRadial, ProgressBar, getModalStore } from '@skeletonlabs/skeleton';
		...
		<div class="relative inline-block text-left">
			<div>
				<button
					...
					type="button"
					class="inline-flex w-full justify-center gap-x-1.5 rounded-lg px-3 hover:bg-white hover:text-black py-2 text-sm font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-300"
					id="menu-button"
					aria-expanded="true"
					aria-haspopup="true"
				>
...
{#if loading}
	<div class="z-40 absolute w-full top-1/3 pl-6">
		<p class="text-4xl my-5 text-center animate-bounce">Cargando articulos</p>
		<ProgressRadial
			value={loadingValue}
			class="mx-auto"
			stroke={20}
